...
//207. Course Schedule
//Medium
//Time Complexity:  O ( ∣ E ∣ + ∣ V ∣^ 2 ) where   E is the number of dependencies,
//  ∣V∣ is the number of courses and  d is the maximum length of acyclic paths in the graph.
public class LeetCode207_Course_Schedule {
    class Solution {
        ...
        /*
         * postorder template.DFS check that no cycle would be formed starting from currCourse
         */
        protected boolean isCyclic(
            ...
            boolean ret = false;
            // postorder template.DFS, to visit all its children first.
