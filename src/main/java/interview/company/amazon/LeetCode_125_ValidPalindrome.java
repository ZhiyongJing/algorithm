...
public class LeetCode_125_ValidPalindrome {
    ...
    public static void main(String[] args) {
        leetcode.question.two_pointer.LeetCode_125_ValidPalindrome.Solution solution = new leetcode.question.two_pointer.LeetCode_125_ValidPalindrome().new Solution();
