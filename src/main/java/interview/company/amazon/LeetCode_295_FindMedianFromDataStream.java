...
//leetcode submit region end(Prohibit modification and deletion)
    ...
    public static void main(String[] args) {
        leetcode.question.heap.LeetCode_295_FindMedianFromDataStream.MedianFinder medianFinder = new leetcode.question.heap.LeetCode_295_FindMedianFromDataStream().new MedianFinder();
