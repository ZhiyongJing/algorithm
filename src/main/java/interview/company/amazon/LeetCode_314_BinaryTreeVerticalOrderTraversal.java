...
public class LeetCode_314_BinaryTreeVerticalOrderTraversal {
    ...
    public static void main(String[] args) {
        leetcode.question.bfs.LeetCode_314_BinaryTreeVerticalOrderTraversal solution = new leetcode.question.bfs.LeetCode_314_BinaryTreeVerticalOrderTraversal();
        leetcode.question.bfs.LeetCode_314_BinaryTreeVerticalOrderTraversal.Solution verticalOrderSolution = solution.new Solution();
