...
//leetcode submit region end(Prohibit modification and deletion)
    ...
    public static void main(String[] args) {
        leetcode.question.sort.LeetCode_56_MergeIntervals.Solution solution = new leetcode.question.sort.LeetCode_56_MergeIntervals().new Solution();
...
Explanation: Intervals [1,4] and [4,5] are considered overlapping.
 ...
 Related Topics Array Sorting 👍 21905 👎 763
