...
//leetcode submit region end(Prohibit modification and deletion)
    ...
    public static void main(String[] args) {
        leetcode.question.bfs.LeetCode_98_ValidateBinarySearchTree.Solution solution = new leetcode.question.bfs.LeetCode_98_ValidateBinarySearchTree().new Solution();
        // TO TEST
        //solution.
    }
}
