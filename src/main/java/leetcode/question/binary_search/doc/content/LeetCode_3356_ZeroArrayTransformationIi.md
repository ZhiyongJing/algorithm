...
<ul> 
 ...
 <li>The amount by which each value is decremented
  <!-- notionvc: b232c9d9-a32d-448c-85b8-b637de593c11 --> can be chosen <strong>independently</strong> for each index.</li> 
</ul>
...
<ul> 
 <li><strong>For i = 0 (l = 0, r = 2, val = 1):</strong> </li>
</ul>
...
<ul> 
 <li><strong>For i = 0 (l = 1, r = 3, val = 2):</strong> </li>
</ul>
...
<div><div>Related Topics</div><div><li>Array</li><li>Binary Search</li><li>Prefix Sum</li></div></div><br><div><li>👍 886</li><li>👎 80</li></div>