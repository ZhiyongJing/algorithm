...
>    >
>    > 通过单位时间所生产的东西来计量，例如内存带宽（memory bandwidth）用来衡量内存系统的吞吐量，而对于Web系统，QPS（Queries Per Second）：用来衡量信息检索系统（如搜索引擎、数据库等）在1秒内的搜索流量
>    >
...
> - **Forward Proxy**
>   
>   ![image-20240422001443554](System_Design经验总结.assets/image-20240422001443554.png)
>   
>   正向代理是对外的，面向外部资源*，用来从网络上获取各种数据。 代客户端发出资源请求，并将响应结果返回给对应的客户端。所以，*正向代理更靠近客户端，与客户端的关系更密切*（跟服务器关系一般，不熟）
> - **Reverse Proxy**
>   ![image-20240422001513601](System_Design经验总结.assets/image-20240422001513601.png)
...
>   ![image-20240422010949876](System_Design经验总结.assets/image-20240422010949876.png)
>
...
>   ![image-20240422011615287](System_Design经验总结.assets/image-20240422011615287.png)
...
>>> - 海量数据无限存储，PB级别数据随便存，hbase 底层基于HDFS（Hadoop文件系统），数据持久化
